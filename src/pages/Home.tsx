...
export default function Home() {
  return (
    <div className="min-h-screen">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              ...
              className="bg-amber-600 hover:bg-amber-700 text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 transform hover:scale-105 inline-block text-center"
            >
              Make a Reservation
            </a>
            ...
            {/* Features Section */}
            <section className="py-20 bg-theme-900">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="text-center p-8 bg-theme-700 rounded-lg hover:bg-theme-600 transition-colors duration-300">
      ...
      {/* Call to Action */}
      <section className="py-20 bg-theme-700">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <button 
            ...
            onClick={() => window.location.href = 'https://www.opentable.com/blackhorn-steakhouse'}
          >
