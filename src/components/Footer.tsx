      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <h3 className="text-2xl font-bold text-white mb-4">The Blackhorn Steakhouse</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-300">Private Dining</a></li>
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-300">
              ...
              <p className="mt-4">
                ...
                <span className="text-white">(416) 449-2841</span>
              </p>
              <p>
                <span className="block">Email:</span>
                <span className="text-white">blackhornscarborough@gmail.com</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            ...
            <p className="text-gray-500 text-xs mt-2">Powered by Ulysium MetaEngine (Pvt) Ltd.</p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a href="#" className="text-gray-400 hover:text-white text-sm transition-colors duration-300">Privacy Policy</a>
            <a href="#" className="text-gray-400 hover:text-white text-sm transition-colors duration-300">Terms of Service</a>
            <a href="#" className="text-gray-400 hover:text-white text-sm transition-colors duration-300">Accessibility</a>
          </div>
        </div>
      </div>
    </footer>
